...
public class TxProductService {
	...
	@Transactional(readOnly = false, propagation = Propagation.REQUIRED, isolation = Isolation.DEFAULT)//, rollbackFor = {ALittleSeriousException.class })
	...
	private static void troubleMaker() throws ALittleSeriousException {
		throw new ALittleSeriousException("a little error");
	}
